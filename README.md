...
* **ML Algorithm:** Polynomial Regression (Scikit-Learn)
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/tanishaasaklani/fuel-consumption-predictor.git](https://github.com/tanishaasaklani/fuel-consumption-predictor.git)
